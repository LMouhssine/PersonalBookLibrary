export default class UI {
    ...
    addBookToList(book) {
        ...
        bookElement.innerHTML = `
            ...
            <button class="mark-read" data-id="${book.id}">${book.status === 'completed' ? 'Mark Unread' : 'Mark Read'}</button>
    ...
    updateBook(id, updatedBook) {
        ...
        bookElement.innerHTML = `
            ...
            <button class="mark-read" data-id="${id}">${updatedBook.status === 'completed' ? 'Mark Unread' : 'Mark Read'}</button>
